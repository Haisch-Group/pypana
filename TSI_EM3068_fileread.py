...
def import_data(filename, data_choice=""):
    ...
    flowrate = input("Please enter the used flow rate as float in L/min") # could be logged
...
if __name__ == "__main__":
    ...
    data_dict = \
        import_data_dict(device_list.query("Import_Script=='TSI_EM3068_fileread'")["Device_Identifier"].values[0], filename)
